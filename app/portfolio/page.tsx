...
import { EVENTS_DATA, MV_ARTWORKS_DATA, LOGO_DATA } from "@/data/content";
...
function PortfolioGrid() {
    ...
    // Prepare unified dataset for the grid
    ...
    if (activeTab === "all" || activeTab === "mv-artworks") {
        displayedItems = [
            ...displayedItems,
            ...MV_ARTWORKS_DATA.map((item) => ({
                ...item,
                type: "mv-artworks",
                unifiedImage: item.img,
    ...
    const getBentoSpan = (index: number) => {
        // Create an asymmetrical layout pattern repeated every 5 items
    ...
    return (
        <div className="w-full">
            ...
            <div className="flex flex-wrap justify-center gap-2 md:gap-4 mb-16 relative z-10">
                {TABS.map((tab) => (
                    <button
                        ...
                        className={`relative px-6 py-2 rounded-full font-share-tech text-xs tracking-wider uppercase transition-all duration-300 border overflow-hidden ${activeTab === tab.value
            ...
            {/* Bento Grid Showcase */}
            <motion.div layout className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 auto-rows-[280px] md:auto-rows-[300px] gap-4 md:gap-6 w-full">
                <AnimatePresence mode="popLayout">
                    {displayedItems.length > 0 ? (
                        displayedItems.map((item, index) => (
                            ...
                            >
                                <div className="absolute inset-0 h-full w-full overflow-hidden">
                                    <Image
                                        src={item.unifiedImage || "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=2564&auto=format&fit=crop"}
                                        alt={item.title}
                                        fill
                        ...
                        >
                            <h3 className="font-contrail text-3xl text-gray-600 mb-4">No Items Found</h3>
                ...
                <AnimatePresence>
                    {selectedItem && (
                        ...
                        >
                            ...
                            <motion.img
                                src={selectedItem.unifiedImage || "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=2564&auto=format&fit=crop"}
                ...
                <div className="text-center mb-16 md:mb-24">
                    ...
                    >
                        ...
                        <p className="font-base-neue text-gray-400 max-w-2xl mx-auto text-sm md:text-base leading-relaxed">
                            Explore our complete collection of live events, visual artworks, brand identities, and exclusive apparel.
