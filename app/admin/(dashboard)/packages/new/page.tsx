    ...
    <div className="max-w-3xl mx-auto space-y-6 pb-10">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-400">Add a service package with pricing &amp; features.</p>
        </div>
      </div>
        ...
        <div className="bg-[#161920] border border-gray-800 rounded-xl p-6 space-y-5">
          ...
          {features.map((feature, fi) => (
            <div key={fi} className="flex gap-3 items-center">
              ...
              <input
                type="text"
                placeholder={`Feature #${fi + 1} — e.g. "2 Revision rounds"`}
                value={feature}
